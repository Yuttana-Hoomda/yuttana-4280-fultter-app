...
class QuizScreenPreference extends StatefulWidget {
  const QuizScreenPreference({
    super.key,
  ...
  @override
  State<QuizScreenPreference> createState() => _QuizScreenPreferenceState();
}

class _QuizScreenPreferenceState extends State<QuizScreenPreference> {
  int? selectedIndex;
  ...
  @override
  void didUpdateWidget(covariant QuizScreenPreference oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [IconButton(onPressed: () => Navigator.pushNamed(context, '/setting'), icon: Icon(Icons.settings))],
      ),
      body: SafeArea(
        child: Column(
          children: [
